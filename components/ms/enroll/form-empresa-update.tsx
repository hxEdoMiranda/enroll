...
import { getEmpresa, getEmpresas, postCreateEmpresa } from "@/actions/empresa";
  ...
  const handleSubmit = async (values: IEmpresa) => {
    ...
    try {
      ...
      const companyData: CompanyModel = {
        ...mappedValues,
        country: mappedValues.country.uid || "", // Convierte `CountryModel` a `string`
    };
    
    const result = await postCreateEmpresa(companyData);
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Identifier" {...field} className="text-xs" value={empresa.identifier} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Name" {...field} className="text-xs" value={empresa.name} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Corporate Name" {...field} className="text-xs" value={empresa.corporate_name} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Trade Name" {...field} className="text-xs" value={empresa.trade_name} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Industry Type" {...field} className="text-xs" value={empresa.industry_type} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Business Type" {...field} className="text-xs" value={empresa.business_type} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Company Email" {...field} className="text-xs" value={empresa.company_email} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Company Phone" {...field} className="text-xs" value={empresa.company_phone} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Commercial Manager Name" {...field} className="text-xs" value={empresa?.commercial_manager === undefined? "" : empresa?.commercial_manager[0]?.name} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Commercial Manager Email" {...field} className="text-xs" value={empresa?.commercial_manager === undefined? "" : empresa.commercial_manager[0].mail} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="KAM Name" {...field} className="text-xs" value={empresa?.kam === undefined? "" : empresa.kam[0].name} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="KAM Email" {...field} className="text-xs" value={empresa?.kam === undefined? "" : empresa.kam[0].mail} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <span className="block mb-1 text-primary text-xs">Name</span>
                    <FormControl>
                      <Input placeholder="Contact Name" {...field} className="text-xs" value={empresa?.contact === undefined? "" : empresa.contact[0]?.name} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Contact Phone" {...field} className="text-xs" value={empresa?.contact === undefined? "" : empresa.contact[0]?.phone} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Contact Email" {...field} className="text-xs" value={empresa?.contact === undefined? "" : empresa.contact[0]?.mail} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
